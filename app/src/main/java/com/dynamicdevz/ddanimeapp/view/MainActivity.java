...
public class MainActivity extends AppCompatActivity implements Presenter.JikanView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.getJikanResults("narotu");
    ...
    public void displayResults(List<JikanResult> jikanResults) {
        hideProgressBar();
        runOnUiThread(()-> adapter.setResults(jikanResults));

    }

    private void hideProgressBar(){
        runOnUiThread(()-> binding.loadingProgressbar.setVisibility(View.GONE));
    }
